...
from zhipuai import ZhipuAI, APITimeoutError
import time
...
class ZHIPUAIBot(Bot, ZhipuAIImage):
    ...
    def reply(self, query, context=None):
        ...
        if context.type == ContextType.TEXT:
            ...
            reply_content = self.reply_text(session, api_key, args=new_args, tools=self.tools)
            logger.debug(
    ...
    def reply_text(self, session: ZhipuAISession, api_key=None, args=None, tools=None, retry_count=0) -> dict:
        """
